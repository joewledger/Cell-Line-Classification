...
def generate_patients_expression_matrix(self,patients_directory):
...
def generate_cell_line_mutation_matrix(self,mutation_dict):
	...
	:param mutation_dict: a dictionary with keys as cell lines and entries as mutations on that cell line
	"""
	cell_line_names = set()
	all_mutations = set()
...
def generate_mutation_dict(self,mutation_features_filename):
	"""
